...
window.onload = function () {
    ...
    var setLiveStream = function (stream,remote_name, client_id) {
        ...
        if (!stream.local) {
            ...
            stream.show('liveStream_' + client_id, options);
            countStream++;
        }
        else {
            options.player.height = "inherit";
    ...
    createToken(createDataJson(window.location.href), function (response) {
        ...
        localStream = EnxRtc.joinRoom(token, config, function (success, error) {
            ...
            if (success && success != null) {
                ...
                console.log("localStream VVVVVVVVVVVVVVVVVVVVV", localStream);
                ...
                room.addEventListener("message-received", function (event) {
                    ...
                    $('#messages').append('<div><b>'+ InMsg.sender +' : </b>'+InMsg.message+'</div>');
                });
        ...
        //     // localStream.addEventListner('media-access-allowed', function (response) {
        ...
        //     // localStream.addEventListner('media-access-denied', function (response) {
...
function shareScreen(){
    ...
    streamShare.addEventListener("stream-ended",(a)=>{
        room.stopScreenShare((a)=>{console.log(a)})
    });
}
